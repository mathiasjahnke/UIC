...
to run the project, processings **core.jar** needs to be on the class path. the javadocs for processing can be found here: "http://processing.github.io/processing-javadocs/core/"
